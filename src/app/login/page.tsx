...
export default function Login() {
  ...
  return (
    <section className="relative w-full h-[100vh] flex">
      ...
      <div
        className="flex-[1.5] flex items-center justify-center bg-cover bg-center"
        style={{ backgroundImage: "url(/Rectangle.png)" }}
      >
        <Image src="/Quote.svg" alt="" width={400} height={400} />
      </div>
      <div className="flex-1 bg-white backdrop-blur-lg shadow-lg border-3 border-white/50 flex flex-col items-center justify-center">
        <button
          className="absolute top-4 right-4 p-2 text-black/80 focus:outline-none"
        ...
        {dropdownVisible && (
          ...
          >
            <ul className="space-y-1">
              <li className="hover:bg-dark-blue p-2 rounded cursor-pointer text-dirty-white bg-black">
                Login as a Student
              </li>
              <li className="hover:bg-dark-blue p-2 rounded cursor-pointer text-dirty-white bg-black">
                Login as a Teacher
        ...
        <h2 className="text-4xl font-bold tracking-tight uppercase py-4 mt-5 mr-5 text-left">
          Login
        </h2>
        ...
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
          ...
          <p className="text-left mb-2">
            <input type="checkbox" id="remember" className="font-semibold" />
            <label htmlFor="remember" className="inline-block ml-1.5">
              Remember Me
            </label>
          </p>
          <button
            type="submit"
            className="w-full h-12 rounded-full bg-black text-white text-lg font-semibold uppercase cursor-pointer transition-transform duration-300 hover:scale-105"
          >
            Login
          </button>
        </form>
        <a href="#" className="font-semibold hover:underline italic my-2">
          Forgot Password?
        </a>

        <p className="text-center my-2">
          Don&apos;t have an account?{" "}
          <a href="#" className="font-semibold hover:underline italic">
            Register
          </a>
        </p>
        ...
        <div>
          <ul className="flex items-center justify-around space-x-5 mt-4">
            <a href="#">
              <li className="border group hover:bg-dark-blue border-black w-10 h-10 rounded flex items-center justify-center hover:text-white">
                {/* Google SVG */}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 48 48"
                ...
                >
                  <path
                    className="fill-dark-blue group-hover:fill-white"
            ...
            <a href="#">
              <li className="border border-black w-10 h-10 rounded flex items-center justify-center text-dark-blue hover:text-white hover:bg-dark-blue">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24px"
            ...
            <a href="#">
              <li className="border border-black w-10 h-10 rounded flex items-center justify-center text-[#0077B5] hover:bg-dark-blue hover:text-white group">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24px"
